...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand text-brand" href="alumni-home.php">Alumnus<?php echo " ";?><span class="color-b">(CSE-DIU)</span></a>
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Alumnus</a>
          </li>
          <li class="nav-item">
          ...
          <form method="POST">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input name="password" type="text" class="form-control" id="inputPassword4" value="<?php echo $password; ?>" required>
              </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
              ...
              <input name="personal_email" type="text" class="form-control" id="inputMobNo" value="<?php echo $personal_email; ?>" required>
            </div>
            <div class="form-row">
              <label>Current Country</label>
              <input name="curr_country" type="text" class="form-control" id="inputMobNo" value="<?php echo $curr_country; ?>" required>
            </div>
            <div class="form-row">
              <label>Current Job Positon</label>
              <input name="curr_job_pos" type="text" class="form-control" id="inputMobNo" value="<?php echo $curr_job_pos; ?>" required>
            </div>
            <div class="form-row">
              <label>Current Job Organizaton Name</label>
              <input name="curr_job_organization" type="text" class="form-control" id="inputMobNo" value="<?php echo $curr_job_organization; ?>" required>
            </div>
            <div class="form-row">
              <label>Currently Studying</label>
              <input name="curr_study" type="text" class="form-control" id="inputMobNo" value="<?php echo $curr_study; ?>" required>
            </div>
            <hr>
            <div class="form-row">
